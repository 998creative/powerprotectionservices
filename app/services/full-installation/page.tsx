...
export const metadata: Metadata = {
  title: "UPS Installation | Power Protection Services",
  description:
    "UPS installation service for critical power projects, from survey and design through delivery, commissioning, and handover.",
};
...
const HeroSection = () => (
  <section className="relative overflow-visible border-b border-white/10 bg-[#0a0a0f]">
    ...
    <div className="relative z-20 mx-auto flex min-h-[32rem] max-w-[1352px] items-center px-6 py-16 sm:min-h-[36rem] sm:py-20 lg:min-h-[40rem]">
      <div className="grid gap-10 lg:w-full lg:grid-cols-[7fr_3fr] lg:items-center lg:gap-16">
        <div className="lg:pr-8">
          <div className="max-w-4xl border-l-4 border-[#0066ff] pl-6 sm:pl-8">
            ...
            <p className="mt-8 max-w-3xl text-lg leading-relaxed text-zinc-300 sm:text-xl">
              End-to-end delivery for critical power projects, from site survey
              and system design through installation, commissioning, and handover.
            </p>
          </div>
        ...
        <div className="relative mx-auto mt-6 w-full max-w-none -mb-52 -translate-x-[6%] sm:-mb-56 sm:-translate-x-[3%] lg:mt-0 lg:-mb-56 lg:-ml-40 lg:w-[180%] lg:translate-x-0">
          <Image
...
const WhatWeSupplySection = () => (
  <section className="border-b border-[#d9e1f1] bg-white">
    <div className="mx-auto max-w-[1352px] px-6 pb-16 pt-24 md:py-20">
      <WhatWeSupplyCards />
...
const BottomCtaSection = () => (
  <section className="bg-[#0c162b]">
    <div className="mx-auto max-w-[1352px] px-6 py-16 text-center text-white md:py-20">

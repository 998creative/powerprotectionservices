const HeroSection = () => {
  return (
    <section className="relative overflow-hidden border-b border-white/10 bg-[#0a0a0f]">
      <div className="pointer-events-none absolute -top-28 right-[-14rem] h-[34rem] w-[34rem] rounded-full border border-white/10 opacity-60" />
      <div className="pointer-events-none absolute bottom-[-18rem] left-[-10rem] h-[30rem] w-[30rem] rounded-full border border-[#0066ff]/25" />
      <div className="mx-auto max-w-6xl px-6 pb-36 pt-32 sm:pb-40 sm:pt-36 lg:pt-44">

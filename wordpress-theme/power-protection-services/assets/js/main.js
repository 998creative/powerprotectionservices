(() => {
  ...
  const initAboutCardsStack = () => {
    const stacks = Array.from(document.querySelectorAll('[data-about-stack]'));
    ...
    const updateStacks = () => {
      stacks.forEach((stack) => {
        ...
        const stage = stack.querySelector('[data-about-stack-stage]');
        const track = stack.querySelector('[data-about-stack-track]');

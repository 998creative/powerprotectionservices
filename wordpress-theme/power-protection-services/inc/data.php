...
function pps_services_data(): array
{
    ...
    $data = [
        [
            ...
            'hero_title' => 'Site Surveys & System Health Checks',
            'slug'  => 'site-surveys',
            'href'  => home_url('/services/site-surveys/'),
            'description' => 'On-site technical assessments to define critical load, constraints, and the right protection plan.',
        ...
        [
            ...
            'hero_title' => 'Emergency Lighting',
            'slug'  => 'emergency-lighting',
            'href'  => home_url('/services/emergency-lighting/'),
            'description' => 'Emergency lighting design, testing, and support to keep facilities safe and compliant.',
        ...
        [
            ...
            'hero_title' => 'Electrical Installation',
            'slug'  => 'electrical-installation',
            'href'  => home_url('/services/electrical-installation/'),
            'description' => 'Commercial electrical installation works delivered by qualified engineers to current standards.',
